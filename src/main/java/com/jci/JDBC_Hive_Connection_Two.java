            ...
            Connection conn = (Connection) Subject.doAs(signedOnUserSubject, new PrivilegedExceptionAction<Object>()
                    ...
                    public Object run() 
                    {
                            ...
                            try {
                            	...
                            	System.out.println("Publishing to Git. Attepmt 01. Change 02");
                            	System.out.println("Publishing to Git. Attepmt 01. Change 03");
                            	System.out.println("Publishing to Git. Day 02. Change 04");
                            	System.out.println("Publishing to Git. Day 02. Change 05");
                            	System.out.println("Publishing to Git. Day 02. Change 06");
                            	System.out.println("Publishing to Git. Day 03. Change 07");
